  ...
  return (
    <div className="mt-4 p-6 bg-white shadow-lg rounded-lg w-full max-w-md text-center">
      ...
      <div className='flex flex-col items-center justify-center mt-4'>
        ...
        <button onClick={handleCopyToClipboard} className="bg-white-500 border border-1 border-gray-700 text-black py-2 px-6 rounded-lg hover:bg-gray-800 hover:text-white transition duration-300">
          Copy
          </button>
      </div>
    </div>
